...
echo ""
echo "marimo edit $NOTEBOOK_FILE --port 2718 --headless --allow-origins 'http://localhost:8000' --no-token"
echo ""
echo "Or if using pipx:"
echo "pipx run marimo edit $NOTEBOOK_FILE --port 2718 --headless --allow-origins 'http://localhost:8000' --no-token"
echo ""
